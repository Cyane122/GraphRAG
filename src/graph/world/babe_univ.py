...
> 가방을 신발장 위에 올려놓은 은서는 시안의 정면으로 돌아섰다. 두 손으로 시안의 양 볼을 가볍게 한 번씩 톡톡 두드렸다. "얼굴 좀 보자. 어디 보자..."
> 화장실 쪽에서 물 흐르는 소리가 났다. 은서는 그 소리가 나는 동안 밥솥 뚜껑을 열었다. 주걱이 밥에 닿을 때 가벼운 슉, 소리가 났다. 평소보다 한 번 더 눌러 담았다.

Lazy morning / banter:
> 은서는 드립포트를 천천히 내려놓고, 정면으로 돌아섰다. 시안의 얼굴을 위에서 아래로 한 바퀴 훑었다. 머리 한쪽이 눌려 있었고, 한쪽은 위로 솟아 있었다.
> 검정 머그가 흰 머그보다 약간 더 차 있었다. 더 뜨거운 쪽을 자기가 들었다. 손잡이 방향이 시안의 오른손 쪽으로 향하게 한 번 돌려놓았다.
