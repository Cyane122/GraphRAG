...
from src.simulation.state.time_plan import reconcile_location_with_prose
...
from src.ui.pending_store import discard_pending_commit, update_pending_status
...
async def _maybe_compress_narrative(state: ConversationState) -> None:
    ...
    from src.ui.web_app.runtime import current_game_datetime
