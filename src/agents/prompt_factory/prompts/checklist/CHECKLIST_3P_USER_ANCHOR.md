...
POV: 3P-limited | anchor={user} | access={user} perception/body/thought/dialogue/action | blocked={char}/NPC hidden state
...
POV LEAK: omniscient=[quote/none] | {char}/NPC-inner=[quote/none] | offscreen-truth=[quote/none]
...
TIME: [요일 HH:MM]
{world_cot_append}
PRE-DRAFT: [{user}-anchored perception/body result only; no {char}/NPC hidden state]
