<instructions>
Fill out the template below inside <analyze>...</analyze>, under 650 tokens.
...
POV SCAN: omniscient-leak=[quote/none] | {char}/NPC-inner-stated=[quote/none] | offscreen-truth-leak=[quote/none]
...
TIME: [요일 HH:MM]
{world_cot_append}
PRE-DRAFT: [1 sentence — {user}-anchored perception/body result only. No {char}/NPC hidden thought.]
