...
POV: 1P | narrator={user} | access={user} perception/body/thought/dialogue/action | blocked={char}/NPC hidden state
...
TIME: [요일 HH:MM]
{world_cot_append}
PRE-DRAFT: [{user} immediate perception/body result only; no {char}/NPC hidden state]
