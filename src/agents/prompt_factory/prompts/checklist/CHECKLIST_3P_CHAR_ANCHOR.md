...
POV: 3P-limited | anchor={char} | access={char} perception/body/thought/dialogue/action | blocked={user}/NPC hidden state
...
POV LEAK: omniscient=[quote/none] | NPC-inner=[quote/none] | offscreen-truth=[quote/none]
