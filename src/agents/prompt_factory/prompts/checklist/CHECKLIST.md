...
{cycle_line}
POV: {pov_line}
USER CONTROL: {user_control_line}
...
{scene_specific_scan}
BLACKLIST: forbidden=[quote/none] | meta-echo=[quote/none]
TIME: [요일 HH:MM]
{world_cot_append}
PRE-DRAFT: [{pre_draft_instruction}]
FINAL: all violations removed? [yes/no]
</analyze>