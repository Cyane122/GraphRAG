...
#
# Accepted actor responses are converted into persistent Graph state changes.
...
#
# Functions
#   - apply_graph_actor_response(actor_response, npc_id, pc_id, scene_types, scene_chars, world_config, manager_effects, history_snapshot, recent_snapshot, thread_id, commit_id, user_input) -> str | None : Apply accepted actor response side effects to Graph state.
...
async def apply_graph_actor_response(
    actor_response: str,
    npc_id:         str,
    pc_id:          str,
