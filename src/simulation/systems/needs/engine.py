# ================================
# src/simulation/systems/needs/engine.py
#
# Graph NPC 욕구의 시간 경과, 임계 해소와 자율 행동 실행을 조정합니다.
#
# Functions
...
#   - _resolve_autonomous_need(npc: dict, need_name: str, current_time: datetime, schedule_rows: list[dict], valid_locations: list[dict], overflow_count: int = 1, minutes_after_first: float = 0.0, extra_context: str = "") -> list[str] : 욕구 임계 초과를 자율 행동으로 해소합니다.
