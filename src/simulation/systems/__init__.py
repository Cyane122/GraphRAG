...
#   - run_needs_update(pc_id: str, elapsed_minutes: float, current_time: datetime) -> dict : Update all NPC need states.
...
#   - propagate_gossip(event_id: str, source_char_id: str, pc_id: str, importance: int, relationship_delta: int, current_time: datetime) -> None : Propagate reputation changes.
