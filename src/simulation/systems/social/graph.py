...
#
# Korean-name generation and Hangul romanization helpers moved to naming.py.
# ================================
import hashlib
import json
import re
...
from src.simulation.systems.social.naming import (
    _alt_surname,
    _compose_name,
    _fallback_given_name,
    _kor_to_roman_id,
    _romanize_hangul,
    _FALLBACK_GIVEN_NAMES,
    _FALLBACK_GIVEN_NAMES_ROMAN,
    _KOREAN_SURNAME_ROMAN,
    _SURNAME_POOL,
)
