# ================================
# src/apps/graph_viewer/server.py
#
...
_ROOT_VIEWER = Path(__file__).resolve().parents[3] / "frontend" / "ppt_viewer.html"
...
class _GraphHandler(BaseHTTPRequestHandler):
    ...
    def _send_threads(self) -> None:
        ...
        try:
            from src.apps.graph_viewer.loader import list_threads
    ...
    def _handle_load(self) -> None:
        ...
        try:
            ...
            from src.apps.graph_viewer.loader import build_graph_from_thread
            try:
    ...
    def _handle_node_write(self) -> None:
        ...
        try:
            ...
            from src.apps.graph_viewer.writer import write_node
    ...
    def _handle_edge_write(self) -> None:
        ...
        try:
            ...
            from src.apps.graph_viewer.writer import write_edge
