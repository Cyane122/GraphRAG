...
from src.apps.world_editor import compiler, field_types as ft_module, migrate, prompts, repair, scaffold, schedules, source_create, source_edit, worlds
from src.apps.world_editor.models import (
    AliasEditRequest,
    BlobEditRequest,
...
# world_editor 프론트엔드는 frontend/world_editor.html 에 둔다.
